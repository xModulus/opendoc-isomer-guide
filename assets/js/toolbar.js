(function () {
    ...
    editButtons.forEach(function (btn) {
        btn.addEventListener('click', function () {
            var repoUrl = 'https://github.com/opendocsg/opendoc-isomer-guide' + '/blob/master/'
    ...
    printButtons.forEach(function (btn) {
        btn.addEventListener('click', function () {
            ...
            var replacedRepoName = 'opendocsg/opendoc-isomer-guide'.replace(/\//g, '-') + (isProd ? '' : '-staging')
            var pdfUrl = 'true' === 'true' ?
                '/opendoc-isomer-guide/assets/pdfs' :
