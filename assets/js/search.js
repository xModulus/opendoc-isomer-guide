(function () {
    ...
    var endpoint = null
    var env = 'production'
    var elasticSearchIndex = 'opendocsg-opendoc-isomer-guide'
    ...
    function getLunrIndex() {
        return fetch('/opendoc-isomer-guide/assets/lunrIndex.json')
            .then(function (res) {
                    return res.json()
            })
            .then(function (json) {
    ...
    var generateResultHTML = function (result, i) {
        ...
        searchTitle.innerHTML = result.documentTitle || "Isomer Guide"
